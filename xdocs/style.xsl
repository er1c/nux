...
<!-- $Id: style.xsl,v 1.2 2006/05/20 21:48:05 hoschek3 Exp $          -->
<!-- ================================================================= -->
				...
				<table border="0" width="100%" cellspacing="4">
					<tr>
						...
						<td valign="top" align="left" nowrap="nowrap" class="leftcol">
							<xsl:if test="$project/body/@menuWidth"> 
								<xsl:attribute name="width"><xsl:value-of select="$project/body/@menuWidth"/></xsl:attribute>
							</xsl:if>
						...
						<xsl:if test="$project/rightbody/menu">
							...
							<xsl:if test="$project/rightbody/@menuWidth"> 
								<xsl:attribute name="width"><xsl:value-of select="$project/rightbody/@menuWidth"/></xsl:attribute>
							</xsl:if>
